...
export default function BusinessDetail() {
  ...
  const fetchData = async () => {
    ...
    setError('');
    try {
      const bizRes = await axios.get(`https://pulsesquarek.onrender.com/api/businesses/${id}`);
      const revRes = await axios.get(`https://pulsesquarek.onrender.com/api/businesses/${id}/reviews`);
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`https://pulsesquarek.onrender.com/api/businesses/${id}/reviews`, newReview, {
